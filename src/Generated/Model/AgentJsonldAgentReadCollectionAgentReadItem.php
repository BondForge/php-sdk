...
/**
 * AgentJsonldAgentReadCollectionAgentReadItem
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * AgentJsonldAgentReadCollectionAgentReadItem Class Doc Comment
 *
 * @category Class
 * @package  BondForge\Sdk\Generated
 * @author   OpenAPI Generator team
 ...
 */
final class AgentJsonldAgentReadCollectionAgentReadItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Agent.jsonld-agent.read.collection_agent.read.item';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('agencies', $data ?? [], null);
    ...
    */
     ...
     * Sets agencies
     *
     * @param string[]|null $agencies agencies
     *
     * @return self
     */
    ...
    {
        if (is_null($agencies)) {
            throw new \InvalidArgumentException('non-nullable agencies cannot be null');
        }
