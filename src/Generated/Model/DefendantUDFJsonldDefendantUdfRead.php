...
final class DefendantUDFJsonldDefendantUdfRead implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DefendantUDF.jsonld-defendant_udf.read';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('udfType', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getUdfType()
    {
        return $this->container['udfType'];
    }

    /**
     * Sets udfType
     *
     * @param string|null $udfType udfType
     *
     * @return self
     */
    public function setUdfType($udfType)
    {
        if (is_null($udfType)) {
            throw new \InvalidArgumentException('non-nullable udfType cannot be null');
        }
        $this->container['udfType'] = $udfType;
