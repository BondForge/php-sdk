 ...
 */
final class ConstraintViolationViolationsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets propertyPath
     *
     * @param string|null $propertyPath The property path of the violation
     *
     * @return self
     */
     ...
     * Sets message
     *
     * @param string|null $message The message associated with the violation
     *
     * @return self
     */
