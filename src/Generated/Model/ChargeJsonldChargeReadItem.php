...
/**
 * ChargeJsonldChargeReadItem Class Doc Comment
 *
 * @category Class
 * @package  BondForge\Sdk\Generated
 * @author   OpenAPI Generator team
 ...
 */
final class ChargeJsonldChargeReadItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Charge.jsonld-charge.read.item';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('courts', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['courts'];
    }

    /**
     * Sets courts
     *
     * @param string[]|null $courts courts
     *
     * @return self
     */
    ...
    {
        if (is_null($courts)) {
            throw new \InvalidArgumentException('non-nullable courts cannot be null');
        }
        $this->container['courts'] = $courts;
