...
/**
 * CourtJsonldCourtReadCollectionCourtReadItem
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * CourtJsonldCourtReadCollectionCourtReadItem Class Doc Comment
 *
 * @category Class
 * @package  BondForge\Sdk\Generated
 * @author   OpenAPI Generator team
 ...
 */
final class CourtJsonldCourtReadCollectionCourtReadItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Court.jsonld-court.read.collection_court.read.item';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('courtType', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['courtType'];
    }

    /**
     * Sets courtType
     *
     * @param string|null $courtType courtType
     *
     * @return self
     */
    public function setCourtType($courtType)
    {
        if (is_null($courtType)) {
            throw new \InvalidArgumentException('non-nullable courtType cannot be null');
        }
        $this->container['courtType'] = $courtType;
