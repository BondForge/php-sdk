...
class HydraCollectionBaseSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HydraCollectionBaseSchema';
    ...
    */
    ...
    public function setTotalItems($totalItems)
    {
        ...
        if (($totalItems < 0)) {
            throw new \InvalidArgumentException('invalid value for $totalItems when calling HydraCollectionBaseSchema., must be bigger than or equal to 0.');
        }
