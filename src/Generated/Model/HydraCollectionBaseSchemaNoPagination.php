...
final class HydraCollectionBaseSchemaNoPagination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HydraCollectionBaseSchemaNoPagination';
    ...
    */
    ...
    public function setTotalItems($totalItems)
    {
        ...
        if (($totalItems < 0)) {
            throw new \InvalidArgumentException('invalid value for $totalItems when calling HydraCollectionBaseSchemaNoPagination., must be bigger than or equal to 0.');
        }
