...
final class HydraCollectionBaseSchemaNoPaginationSearch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HydraCollectionBaseSchemaNoPagination_search';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('variableRepresentation', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($variableRepresentation)) {
            throw new \InvalidArgumentException('non-nullable variableRepresentation cannot be null');
        }
